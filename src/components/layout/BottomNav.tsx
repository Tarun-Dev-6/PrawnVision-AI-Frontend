...
const navItems = [
  ...
  { icon: Camera, label: "Capture", path: "/capture", isMain: true },
        ...
        {navItems.map((item) => {
          ...
          if (item.isMain) {
            return (
              ...
              >
                <div className="ocean-gradient rounded-full p-4 shadow-elevated hover:brightness-110 transition-all active:scale-95">
